...
def perimeter_coords(array):
    ...
    """
    A function to calculate tumor perimeter
    """
...
def tumor_geo_calc(data_folder, feature_folder, figure_folder,
    ...
    """
    A function called for calculating tumor geometric feature
    for a given time point

    data_folder - str, path to folder storing simulation data
    feature_folder - str, path to folder storing geo features
    figure_folder - str, path to folder storing snapshots
    rep_inx - int, the repeat number
    iter_inx - int, the iteration number
    timepoint - [int, int], start and end time point to analyze
    """
