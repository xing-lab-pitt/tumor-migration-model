...
# scan parameter
lambda_fpp_glob = {{fpp_scan}}
force_strenth_max = {{force_scan}}
...
class migration_racdir_fppSteppable(SteppableBasePy):
    ...
    def step(self,mcs):
        ...
        for cell in self.cell_list:
            ...
            # define a list for past x and y positions
        ...
        if mcs > relax_step:
            ...
            for cell in self.cell_list:
                ...
                cell.dict["x_self_polarity"] = x_self_polarity # displacement vector x
                cell.dict["y_self_polarity"] = y_self_polarity # displacement vector y
...
class OdeUpdateParams(SteppableBasePy):
    ...
    def step(self, mcs):
        if mcs>relax_step:
            ...
            # for each cell, collecting the mean neighbor cell polarity
            neighbor_x_list = []
            neighbor_y_list = []
            for cell in self.cell_list:
                neighbor_x_self = []
